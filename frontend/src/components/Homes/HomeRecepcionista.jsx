...
const HomeRecepcionista = () => {
  ...
  const actions = [
    ...
    { title: "GENERAR ORDEN REPARACION", desc: "Levantar orden de reparación en el sistema", icon: <FaComputer />, path: "/ordenes" },
    { title: "COMPROBANTE DE ORDEN", desc: "Comprobante de registro del equipo", icon: <FaFilePdf />, path: "/comprobantes" },
  ];
